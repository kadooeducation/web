            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="space-y-4">
                ...
                <p className="text-xl text-white/90">
                  Encontre a oportunidade perfeita para acelerar seu negócio
                </p>
                <div className="flex items-center gap-4 text-white/80">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {editaisData.reduce((acc, e) => acc + e.participants, 0)}+
                      vagas
                    </span>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-gray-50 p-2 rounded-lg group-hover:bg-white group-hover:shadow-sm transition-all duration-300">
                      <div className="flex items-center gap-1 text-xs font-medium">
                        ...
                        <span className={getDifficultyColor(edital.difficulty)}>
                          {edital.difficulty}
                        </span>
                      </div>
                    </div>
