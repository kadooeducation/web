...
const mentores = [
  {
    ...
    status: 'online',
    description:
      'Especialista em marketing digital com foco em growth hacking e aquisição de usuários. Já ajudou mais de 50 startups a crescer exponencialmente.',
    skills: [
      'Growth Hacking',
      'Google Ads',
      'Facebook Ads',
  ...
  },
  {
    ...
    status: 'busy',
    description:
      'Product Manager sênior com experiência em empresas de tecnologia. Especializado em estratégia de produto e metodologias ágeis.',
  ...
  },
  {
    ...
    status: 'online',
    description:
      'CFO experiente com histórico em captação de recursos e gestão financeira de startups em crescimento.',
  ...
  },
  {
    ...
    status: 'online',
    description:
      'Empreendedor social com foco em projetos de impacto. Especializado em negócios com propósito social.',
    skills: [
      'Impact Business',
      'Fundraising',
      'Social Media',
  ...
  },
  {
    ...
    status: 'online',
    description:
      'Tech Lead com expertise em inteligência artificial e machine learning. Mentora em transformação digital.',
    skills: [
      'AI/ML',
      'Python',
      'Data Science',
  ...
  },
  {
    ...
    status: 'busy',
    description:
      'Diretor comercial com vasta experiência em vendas B2B e estruturação de times comerciais de alta performance.',
    skills: [
      'Sales Strategy',
      'B2B Sales',
      'CRM',
  ...
  },
  {
    ...
    status: 'online',
    description:
      'UX Designer sênior especializada em design de produtos digitais e research. Foco em experiência do usuário.',
  ...
  },
  {
    ...
    status: 'online',
    description:
      'Head of People com experiência em estruturação de times e cultura organizacional em startups e scale-ups.',
    skills: [
      'People Management',
      'Culture',
      'Hiring',
...
export default function MentorsPage() {
  ...
  const filterAndSortMentors = useCallback(() => {
    const filtered = mentores.filter((mentor) => {
      const matchesSearch =
      ...
      const matchesArea =
        selectedArea === 'Todas as Áreas' || mentor.area === selectedArea
            ...
            <div className="space-y-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  ...
                  empreendedora. Mais de 50+ mentores experientes prontos para
            ...
            <div className="flex items-center justify-between">
              <p className="text-gray-600">
                ...
                {selectedArea !== 'Todas as Áreas' && (
                  <span>
                    {' '}
                    em <span className="font-semibold">{selectedArea}</span>
                  </span>
                )}
              </p>
            </div>
              ...
              {filteredMentors.map((mentor) => (
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
                    <div
                      className={`w-3 h-3 rounded-full ${statusColors[mentor.status as keyof typeof statusColors]}`}
                    ></div>
                    <span className="text-xs font-medium text-gray-600">
                      {statusLabels[mentor.status as keyof typeof statusLabels]}
                    </span>
                  </div>
                  ...
                  <CardContent className="p-6 relative z-10">
                    ...
                    <div className="text-center mb-4">
                      <span className="text-lg font-bold text-[#5127FF]">
                        {mentor.price}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2">
                      <Button className="w-full bg-gradient-to-r from-[#5127FF] to-[#5127FF]/90 hover:from-[#5127FF]/90 hover:to-[#5127FF] text-white font-semibold py-2 rounded-xl transition-all duration-300 transform group-hover:scale-105 shadow-md hover:shadow-lg">
                        Agendar Mentoria
                      </Button>
                      <Button
                        variant="outline"
            ...
            <Card className="border-0 shadow-md bg-gradient-to-r from-[#5127FF]/10 to-[#F4DA02]/10 border-[#5127FF]/20">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-lg mb-6">
                  Compartilhe sua experiência e ajude a próxima geração de
